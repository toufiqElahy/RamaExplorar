defmodule Indexer.Block.FetcherTest do
  ...
  describe "import_range/2" do
    ...
    # We can't currently index the whole Ramestta Mainnet, so we don't know what is the first full block.
    #   Implement when a full block is found for Ramestta Mainnet and remove :no_geth tag
    @tag :no_geth
