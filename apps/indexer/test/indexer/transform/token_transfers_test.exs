defmodule Indexer.Transform.TokenTransfersTest do
  ...
  describe "parse/1" do
    ...
    test "token type from database is preferred if the incoming one is different" do
      %{contract_address_hash: hash} = insert(:token, type: "RAMA-1155")
      ...
      assert %{
               token_transfers: [%{token_contract_address_hash: ^contract_address_hash, token_type: "RAMA-1155"}],
               tokens: [%{contract_address_hash: ^contract_address_hash, type: "RAMA-1155"}]
    ...
    test "if there are transfers of different token types, the highest priority will be selected for all" do
      ...
      assert %{
               token_transfers: [
                 %{token_contract_address_hash: ^contract_address_hash, token_type: "RAMA-1155"},
                 %{token_contract_address_hash: ^contract_address_hash, token_type: "RAMA-1155"}
               ],
               tokens: [%{contract_address_hash: ^contract_address_hash, type: "RAMA-1155"}]
