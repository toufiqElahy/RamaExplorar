defmodule EthereumJSONRPC.DecodeError do
  ...
  defmodule Request do
    @moduledoc """
    Ramestta JSONRPC request whose `EthereumJSONRPC.DecodeError.Response` had a decode error.
    """
  ...
  defmodule Response do
    @moduledoc """
    Ramestta JSONRPC response that had a decode error.
    """
  ...
  def message(
    ...
    """
    Failed to decode Ramestta JSONRPC response:
