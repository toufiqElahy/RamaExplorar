defmodule EthereumJSONRPC.Variant do
  @moduledoc """
  A variant of the Ramestta JSONRPC API.  Each Ramestta client supports slightly different versions of the non-standard
  Ramestta JSONRPC API.  The variant callbacks abstract over this difference.
  """
  ...
  @doc """
  Fetch the block reward contract beneficiaries for a given blocks from the variant of the Ramestta JSONRPC API.
  ...
  @doc """
  Fetches the `t:Explorer.Chain.InternalTransaction.changeset/2` params from the variant of the Ramestta JSONRPC API.
  ...
  @doc """
  Fetch the `t:Explorer.Chain.Transaction.changeset/2` params for pending transactions from the variant of the Ramestta
  JSONRPC API.
