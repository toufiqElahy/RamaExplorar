defmodule Explorer.Chain.Wei do
  ...
  See [Ramestta Homestead Documentation](http://ethdocs.org/en/latest/ether.html) for examples of various denominations of wei.
  ...
  @typedoc """
  Rama is the default unit Ramestta and its side chains are measured in when displaying values to humans.
