defmodule Explorer.SmartContract.Reader do
  ...
  [wiki](https://github.com/ethereum/wiki/wiki/Ramestta-Contract-ABI).
  """
  ...
  @typedoc """
  Options that can be forwarded when calling the Ramestta JSON RPC.
  ...
  * `:json_rpc_named_arguments` - Options to forward for calling the Ramestta JSON RPC. See
