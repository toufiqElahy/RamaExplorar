...
/*
 * Interface for requests to the multi-rate oracle (for EUR/RAMA and ERC20)
...
interface MultiOracleRequestI {
    ...
    /**
     * @dev Timestamp of when the last update for the RAMA rate occurred
     */
    function lastUpdate() external view returns (uint256);

    /**
     * @dev Number of EUR per RAMA (rounded down!)
     */
    function ETH_EUR() external view returns (uint256); // solhint-disable func-name-mixedcase

    /**
     * @dev Number of EUR cent per RAMA (rounded down!)
     */
    ...
    /**
     * @dev Emitted on rate update - using address(0) as tokenAddress for RAMA updates
     */
...
library Address {
     ...
     * Requirements:
     *
     * - the calling contract must have an RAMA balance of at least `value`.
...
contract CS3_1OnChainShop {
    ...
    // Buy assets. The number of assets is determined from the amount of RAMA sent.
